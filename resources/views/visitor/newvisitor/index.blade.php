...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_validation" method="POST" action="{{ route('visitor.create') }}" enctype="multipart/form-data">
                  @csrf
                  <!-- fullname -->
                  ...
                  <!-- fullname -->
                    ...
                    <!-- Ocupation -->
                    <div class="form-group form-float">
                      <select name="talked" class="form-control show-tick ms select2" data-placeholder="Talked About Course">
                          <option></option>
