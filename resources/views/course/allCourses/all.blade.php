      ...
      <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="card mcard_4">
              <div class="body">
                  ...
                  <div class="img">
                      <img src="{{ asset('uploads/course') }}/{{ $course->course_thumb }}" class="rounded-circle" alt="profile-image">
                  </div>
                  <a href="{{ url('course/profile') }}/{{ $course->id }}">
                    <div class="user">
                        <h5 class="mt-3 mb-1 title">{{ $course->course_name }}</h5>
                        <h6 class="mt-3 mb-1 fee_title">৳{{ $course->course_fee }}</h6>
                    </div>
                  </a>
