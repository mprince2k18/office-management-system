...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h2><strong>Teacher</strong> Information</h2>
            ...
            <div class="body">
                <form id="form_validation" method="POST" action="{{ route('teacher.create') }}" enctype="multipart/form-data">
                  @csrf
                  <!-- fullname -->
                  ...
                  <!-- mothers name -->
                    ...
                    <!-- Nationality -->
                      ...
                      <!-- Blood Group -->
                      <div class="form-group form-float">
                        <select name="assigned_course" class="form-control show-tick ms select2" data-placeholder="Assigned Course">
                            <option></option>
